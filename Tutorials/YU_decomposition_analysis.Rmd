...
We went through the example of a decomposition for actual earning changes.  You should next try to do the same for the (1) counterfactual predictions and (2) the difference in actual versus counterfactual earnings. This should help you understand what is driving the difference in treatment effects. 
...
# Difference in actual vs counterfactual change in earnings
