...
[RICKY] Add data analysis portion
```{r pre-processed_summary_cps}
write.csv(cps_df_filtered_2,"/cloud/project/Tutorials/Datasets/cps_df_processed.csv", row.names = FALSE)
...
#save(model1, file = paste(save_folder, "lm_reg_cps.rda", sep="/") )
...
#save(lasso_reg_cps, file = paste(save_folder, "lasso_reg_cps.rda", sep="/"))
...
#save(optimal_lambda, file = paste(save_folder, "lasso_opt_lambda.rda", sep="/"))
