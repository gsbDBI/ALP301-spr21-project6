...
ate<-lm(log_d_earn~treatment + male*treatment+male, data = subset(yu_df, black==1))
...
ate<-lm(log_d_earn~treatment + male*treatment+male, data = subset(yu_df, black==0))
beta1 <- summary(ate)$coefficients[2,1]
beta2 <- summary(ate)$coefficients[3,1]
beta3 <- summary(ate)$coefficients[4,1]
...
ate<-lm(log_d_earn~treatment + male + black + male*black + 
          male*treatment + black*treatment + male*black*treatment, 
        data = yu_df)
summary(ate)
